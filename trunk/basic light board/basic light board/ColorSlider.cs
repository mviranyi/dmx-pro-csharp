                                     ...
                                     Color barPenColorPaint, Color elapsedOuterColorPaint, Color elapsedInnerColorPaint)
        {
            try
            {
                ...
                if (barOrientation == Orientation.Horizontal)
                {
                    ...
                    if (invertDirection)
                        TrackX = (ClientRectangle.Width) - TrackX - thumbSize;
                ...
                else
                {
                    ...
                    if (invertDirection)
                        TrackY = (ClientRectangle.Height) - TrackY - thumbSize;
                ...
                if (barOrientation == Orientation.Horizontal)
                {
                    ...
                    if (invertDirection)
                    {
                        elapsedRect.X = thumbRect.Left + thumbSize / 2;
                        elapsedRect.Width = barRect.Width - thumbRect.Left + thumbSize / 2;
                    }
                    else
                    {
